...
class CartPolar:
    ...
    def img2polar(self, img):
        ...
        polar_img = map_coordinates(img, indices, order=self.spline_order, mode='reflect').reshape(img.shape)
    ...
    def gt2polar(self, gt):
        ...
        Rpol_dsz = np.interp(Thetapol_dsz, Thetapol_map, Rpol_map, period=self.row_len)

        return Rpol_dsz, Thetapol_dsz
